...
$(document).ready(function () {
    loadDanhSachMonHoc("5e4a3cc056d25f387f0a8a6b");
    loadSchedule("5e4a3cc056d25f387f0a8a6b");
    autoloadLopHoc("5e4a3cc056d25f387f0a8a6b");
    dangKyHoc("5e4a3cc056d25f387f0a8a6b");
});
...
function loadDanhSachMonHoc(maNguoiDung) {
    ...
    //     if (response === true) {
            $.getJSON("http://localhost:8080/api/lop-hoc/danhSachMonHocChuaHoc/5e4a3cc056d25f387f0a8a6b", function (response) {
                listDanhSachMonHoc = JSON.parse(JSON.stringify(response));
...
function loadSchedule(currentUserId) {
    ...
    $.getJSON("http://localhost:8080/api/student/getSchedule/" + currentUserId + "/5e9295c049dc3d05f638ff6e" , function (response) {
